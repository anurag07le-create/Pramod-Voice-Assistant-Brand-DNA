...
export function OutcomeChart({ calls }) {
    // Helper to format SCREAMING_SNAKE_CASE labels into Title Case
    ...
    const ChartCard = ({ title, children }) => (
        <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm h-[420px] flex flex-col">
            <h3 className="text-lg font-semibold text-gray-800 mb-4 shrink-0">{title}</h3>
